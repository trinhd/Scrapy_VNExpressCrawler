...
class ThethaoSpider(scrapy.Spider):
    name = "thethao"
    allowed_domains = ["thethao.vnexpress.net"]
    start_urls = (
        'http://thethao.vnexpress.net/',
        #'http://thethao.vnexpress.net/tin-tuc/bong-da/sieu-pham-cua-pirlo-dan-dau-10-pha-lam-ban-dep-nhat-tuan-2834425-p11.html',
    )
